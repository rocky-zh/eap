...
//		builder.addPropertyReference("transactionManager", TxNamespaceHandler.getTransactionManagerName(element));
		builder.addPropertyReference("transactionManager", (String) ReflectUtil.invokeMethod(TxNamespaceHandler.class, "getTransactionManagerName", new Class[] {org.w3c.dom.Element.class}, new Object[] {element}));
