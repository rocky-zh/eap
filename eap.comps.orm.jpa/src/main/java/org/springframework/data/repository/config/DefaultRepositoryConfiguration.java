...
//		return ClassUtils.getShortName(interfaceName) + getImplementationPostfix();
		// add chiknin
		String _interfaceName = ClassUtils.getShortName(interfaceName);
		if (_interfaceName.charAt(0) == 'I') {
			_interfaceName = _interfaceName.substring(1);
		}
		return _interfaceName + getImplementationPostfix();
	}
